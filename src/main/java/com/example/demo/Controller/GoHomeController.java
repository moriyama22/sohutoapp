...
import com.example.demo.form.GoHomeForm;
import com.example.demo.Service.GoogleSheetServiceHome;
...
public class GoHomeController {
	...
	@Autowired
    private GoogleSheetServiceHome sheetService;
	
	@GetMapping("/gohome")
	public String showGohomePage(Model model) {
	    ...
	    return "gohome"; // templates/menu.html
	}
	
	@PostMapping("/gohomesubmit")
	public String gohomesubmit(@ModelAttribute GoHomeForm form, Model model) {
        ...
        String EndTimeCell = setting.getEndTimeCell(); // 例："C8"
